...
Route::get('/user/edit/password/{user}',  [App\Http\Controllers\UsersController::class, 'editPassWord'])->name('user_edit');

Route::put('/user/edit/{user}',  [App\Http\Controllers\UsersController::class, 'update'])->name('user_update');

Route::put('/user/edit/password/{user}',  [App\Http\Controllers\UsersController::class, 'updatePassword'])->name('user_update_password');
